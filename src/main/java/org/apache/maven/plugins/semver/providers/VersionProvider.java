...
public class VersionProvider {
  ...
  public Map<FINAL_VERSION, String> determineReleaseVersions(Map<SemverMavenPlugin.RAW_VERSION, String> rawVersions) {
    ...
    StringBuilder scmTag = new StringBuilder();
    scmTag.append(rawVersions.get(SemverMavenPlugin.RAW_VERSION.RELEASE));
    scmTag.append(determineBuildMetaData(rawVersions.get(SemverMavenPlugin.RAW_VERSION.RELEASE)));
    ...
    finalVersions.put(FINAL_VERSION.SCM, scmTag.toString());
    return finalVersions;
  }
  ...
  public Map<FINAL_VERSION, String> determineReleaseBranchVersions(Map<SemverMavenPlugin.RAW_VERSION, String> rawVersions) {
    ...
    String buildMetaData = determineBuildMetaData(rawVersions.get(SemverMavenPlugin.RAW_VERSION.RELEASE));
   ...
   *
   * @param scmVersion version for git-branch
   * @return
   */
  public String determineBuildMetaData(String scmVersion) {
    StringBuilder buildMetaData = new StringBuilder();
    if (configuration != null && configuration.getRunMode() == SemverMavenPlugin.RUNMODE.RELEASE_BRANCH_HOSEE) {
      buildMetaData.append("+");
      buildMetaData.append(scmVersion);
    }
