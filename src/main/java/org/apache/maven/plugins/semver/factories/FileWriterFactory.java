...
public class FileWriterFactory
{
	 ...
	 */
	public static void createReleaseProperties(MavenProject project,
	...
	public static void backupSemverPom()
	{
		...
		try
		{
			...
			{
				LOG.warn(format("Old pom.xml.semverBackup removed  : %s", pomXmlSemverBackup.getAbsolutePath()));
				delete(pomXmlSemverBackup.toPath());
			}
			copy(pomXmlOriginal.toPath(), pomXmlSemverBackup.toPath());

			LOG.info(format("New pom.xml.semverBackup prepared  : %s", pomXmlSemverBackup.getAbsolutePath()));
