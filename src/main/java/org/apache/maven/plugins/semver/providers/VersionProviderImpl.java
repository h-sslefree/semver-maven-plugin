...
public class VersionProviderImpl implements VersionProvider
{
	...
	public Map<RAW_VERSION, String> determineRawVersions(SemverGoal.SEMVER_GOAL semverGoal, RunMode.RUN_MODE runMode,
			String configBranchVersion, String configMetaData, String pomVersion)
			throws SemverException, IOException, GitAPIException
	{
		...
		else
		{
			...
			throw new SemverException("Unrecognized version-pattern",
		...
		{
			scmVersion = determineReleaseBranchTag(runMode, configBranchVersion, patchVersion, minorVersion,
					majorVersion);
	...
	@Override
	public Map<FINAL_VERSION, String> determineReleaseBranchVersions(Map<RAW_VERSION, String> rawVersions,
			RunMode.RUN_MODE runMode, String metaData, String branchVersion)
	{
		...
		logger.info("New DEVELOPMENT-version            : [ {} ]", rawVersions.get(RAW_VERSION.DEVELOPMENT));
		logger.info("New BRANCH GIT build-metadata      : [ {} ]", determineLogBuildMetaData(buildMetaData));
	...
	@Override
	public String determineReleaseBranchTag(RunMode.RUN_MODE runMode, String branchVersion, int patch, int minor,
			int major)
	{
	...
	@Override
	public String determineBuildMetaData(RunMode.RUN_MODE runmode, String metaData, int patch, int minor, int major)
	{
