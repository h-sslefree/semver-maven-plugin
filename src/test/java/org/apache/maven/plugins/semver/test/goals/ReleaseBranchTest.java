...
public class ReleaseBranchTest extends AbstractSemverMavenPluginTest {
  ...
  public void testSemverMavenPluginPatchBranch() throws Exception {
    SemverMavenPluginGoalPatch mojo =
        (SemverMavenPluginGoalPatch) mojoRule.lookupConfiguredMojo(loadPom("rpm/"), "patch");
  ...
  public void testSemverMavenPluginMinorBranch() throws Exception {
    SemverMavenPluginGoalMinor mojo =
        (SemverMavenPluginGoalMinor) mojoRule.lookupConfiguredMojo(loadPom("rpm/"), "minor");
    Assert.assertNotNull(mojo);
    mojo.execute();
  }
  ...
  public void testSemverMavenPluginMajorBranch() throws Exception {
    SemverMavenPluginGoalMajor mojo =
        (SemverMavenPluginGoalMajor) mojoRule.lookupConfiguredMojo(loadPom("rpm/"), "major");
    Assert.assertNotNull(mojo);
    mojo.execute();
  }
}
